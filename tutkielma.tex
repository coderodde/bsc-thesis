...
\While{$|\text{OPEN}| > 0$}{
 ...
 \For{$(u, x) \in G.A$}{
   ...
   \If{$x \not \in \text{\upshape OPEN}$}{
     $\textsc{Insert}(\text{OPEN}, x, g')$ \\
     $g(x) = g'$ \\
     $\pi(x) = u$ \\
   }
   \ElseIf{$g(x) > g'$}{
     $\textsc{Decrease-Key}(\text{OPEN}, x, g')$ \\
     $g(x) = g'$ \\
     $\pi(x) = u$ \\
   }
 }
